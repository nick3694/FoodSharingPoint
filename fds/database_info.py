...
'''
    ...
    # Orders----------------------------------------------------------------------------------------------------
    order1 = Order(id=1, date_order=date(2018, 12, 26),date_order_done=date(2018, 12, 25), user_id=2, point='Porta Nuova')
    order2 = Order(id=2, date_order=date(2019, 11, 20),date_order_done=date(2019, 11, 16), user_id=1, point='Pozzo Strada')


    db.session.add_all([order1,order2])

    bonus1 = Bonus(id=1, date_bonus=date(2018, 12, 25),bonus=500,voucher=None,user_id=2)
    bonus2 = Bonus(id=2, date_bonus=date(2020, 01, 25),bonus=-400,voucher=2,user_id=2)
