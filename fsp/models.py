...
"The database has been introduced through Flask-SQLAlchemy. It is an extension for Flask that adds support for SQLAlchemy."
"The database classes defined are User, Point (physical supermarket),FoodAvailable,Order,Bonus "
