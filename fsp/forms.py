...
"All classes defined in this .py file are subclasses of the Class Form, doing so all classes inherit characteristics of the superclass, such as:" \
" StringField, IntegerField, PasswordField, SubmitField and additional ones." \
" This inheriting is made possible by having imported the class Form from the WTF extension in Flask." \
"" \
"A total of 11 forms has been defined"
